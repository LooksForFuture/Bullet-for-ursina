...
class Ursina(BulletWorld):
    ...
    def __init__(self):
        ...
        base.accept('buttonDown', self.input)
        base.accept('buttonUp', self.input_up)
        base.accept('buttonHold', self.input_hold)
